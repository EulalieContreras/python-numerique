...
# %%
doc.info()
#la colonne size est entièrement nulle
...
doc.dropna(axis='columns', how= 'all', inplace=True)
doc.head() # on a bien enlevé size
...
# %%
doc.loc[88, :] #effectivement elle est vide
doc.dropna(how='all', inplace = True)
doc.head()
...
# %%
doc['Mass (lb) origin'] = doc['Mass (lb)']
